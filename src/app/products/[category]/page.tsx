            ...
            <>
              ...
              <div className="bg-gray-50 rounded-lg p-8 text-center">
                ...
                <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                  Can't find exactly what you're looking for? We specialize in custom manufacturing 
                  and can create {category.name.toLowerCase()} tailored to your specific requirements.
                </p>
...
async function RelatedCategories({ currentCategory }: { currentCategory: any }) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            Explore other {currentCategory.type === 'manufacture' ? 'manufacturing' : 'reseller'} categories
          </p>
        </div>
