...
export async function generateMetadata({ params }: ProductPageProps): Promise<Metadata> {
  try {
    ...
    return seoManager.generateProductMetadata(product);
  } catch (error) {
...
export default async function ProductPage({ params }: ProductPageProps) {
  ...
  try {
    ...
    product = await api.getProductBySlug(category, slug);
    ...
    categoryData = await api.getGenreBySlug(category);
  ...
  const breadcrumbItems = [
    ...
    { name: categoryData.name, href: `/products/${categoryData.slug}` },
    { name: product.name, href: `/products/${categoryData.slug}/${product.slug}` }
  ];
